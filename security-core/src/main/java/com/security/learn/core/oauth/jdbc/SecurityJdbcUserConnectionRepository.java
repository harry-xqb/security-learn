 ...
 **/
public class SecurityJdbcUserConnectionRepository implements UsersConnectionRepository {
    ...
    public SecurityJdbcUserConnectionRepository(DataSource dataSource, ConnectionFactoryLocator connectionFactoryLocator, TextEncryptor textEncryptor) {
    ...
    public ConnectionRepository createConnectionRepository(String userId) {
        ...
        return new SecurityJdbcConnectionRepository(userId, jdbcTemplate, connectionFactoryLocator, textEncryptor, tablePrefix);
    }
